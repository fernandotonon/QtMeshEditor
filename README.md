  ...
  scan-assets-qtmesh:
    ...
    steps:
      ...
      - name: Run QtMesh scan
        uses: fernandotonon/QtMeshEditor@3.16.0
        with:
          command: scan
          image-tag: "3.16.0"
        env:
