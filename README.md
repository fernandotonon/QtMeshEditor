...
For now it is only distributed using the dmg file. When it gets natable enough for homebrew (>30 forks, >30 watchers, or >75 stars), I want to distribute it there.
