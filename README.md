  ...
  scan-assets-qtmesh:
    ...
    steps:
      ...
      - name: Run QtMesh scan
        uses: fernandotonon/QtMeshEditor@3.15.1
        with:
          command: scan
          image-tag: "3.15.1"
        env:
