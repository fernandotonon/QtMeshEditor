  ...
  scan-assets-qtmesh:
    ...
    steps:
      ...
      - name: Run QtMesh scan
        uses: fernandotonon/QtMeshEditor@3.29.0
        with:
          command: scan
          image-tag: "3.29.0"
        env:
