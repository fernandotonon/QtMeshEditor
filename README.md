  ...
  scan-assets-qtmesh:
    ...
    steps:
      ...
      - name: Run QtMesh scan
        uses: fernandotonon/QtMeshEditor@3.14.0
        with:
          command: scan
          image-tag: "3.14.0"
        env:
