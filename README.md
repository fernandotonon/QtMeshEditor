  ...
  scan-assets-qtmesh:
    ...
    steps:
      ...
      - name: Run QtMesh scan
        uses: fernandotonon/QtMeshEditor@3.24.2
        with:
          command: scan
          image-tag: "3.24.2"
        env:
