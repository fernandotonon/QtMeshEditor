...
set(ASSIMP_INC_SEARCH_PATH ${ASSIMP_INC_SEARCH_PATH} ${ENV_ASSIMP_HOME}/include/assimp)
set(ASSIMP_LIB_SEARCH_PATH ${ASSIMP_LIB_SEARCH_PATH} ${ENV_ASSIMP_HOME}/lib/x86)

find_path(ASSIMP_INCLUDE_DIR NAMES ai_assert.h HINTS ${ASSIMP_INC_SEARCH_PATH} ${ASSIMP_PKGC_INCLUDE_DIRS} PATH_SUFFIXES assimp)
