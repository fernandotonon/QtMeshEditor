...
Rectangle {
    ...
    Component {
        ...
        Column {
            ...
            // Paint v2 Slice A — gradient ramp brushes (#544).
            property int colorSource: TexturePaintController.colorSource
            property int gradientMode: TexturePaintController.gradientMode
            property string activeRampName: TexturePaintController.activeRampName
            property bool useFgBgRamp: TexturePaintController.useFgBgRamp
            property bool gradientStepped: TexturePaintController.gradientStepped
            property real rampJitter: TexturePaintController.rampJitter
            property var rampNames: TexturePaintController.rampNames
            property string rampPreviewUri: TexturePaintController.rampPreviewDataUri
            ...
            Connections {
                ...
                function onGradientChanged() {
                    texPaintCol.colorSource = TexturePaintController.colorSource
                    texPaintCol.gradientMode = TexturePaintController.gradientMode
                    texPaintCol.activeRampName = TexturePaintController.activeRampName
                    texPaintCol.useFgBgRamp = TexturePaintController.useFgBgRamp
                    texPaintCol.gradientStepped = TexturePaintController.gradientStepped
                    texPaintCol.rampJitter = TexturePaintController.rampJitter
                    texPaintCol.rampNames = TexturePaintController.rampNames
                    texPaintCol.rampPreviewUri = TexturePaintController.rampPreviewDataUri
                }
            ...
            Column {
                ...
                Row {
                    ...
                    Repeater {
                        model: [
                            { src: 0, label: "Solid" },
                            { src: 1, label: "Gradient" }
                        ]
                        Rectangle {
                            width: 72; height: 24; radius: 3
                            property bool isActive: texPaintCol.colorSource === modelData.src
                            color: isActive
                                ? PropertiesPanelController.highlightColor
                                : (srcMa.containsMouse
                                    ? Qt.lighter(PropertiesPanelController.panelColor, 1.5)
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: TexturePaintController.colorSource = modelData.src
                            }
                        }
                    }
                }
                ...
                Column {
                    spacing: 6
                    width: parent.width
                    visible: texPaintCol.colorSource === 1
                    ...
                    Row {
                        ...
                        Repeater {
                            model: [
                                { mode: 0, label: "Linear" },
                                { mode: 1, label: "Radial" },
                                { mode: 2, label: "Angular" }
                            ]
                            Rectangle {
                                width: 58; height: 22; radius: 3
                                property bool isActive: texPaintCol.gradientMode === modelData.mode
                                color: isActive
                                    ? PropertiesPanelController.highlightColor
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: TexturePaintController.gradientMode = modelData.mode
                                }
                            }
                        }
                    }
                    ...
                    Image {
                        width: parent.width
                        height: 18
                        source: texPaintCol.rampPreviewUri
                    ...
                    Row {
                        ...
                        ThemedComboBox {
                            id: rampCombo
                            width: Math.min(140, parent.width - 100)
                            model: texPaintCol.rampNames
                            currentIndex: Math.max(0, model.indexOf(texPaintCol.activeRampName))
                            onActivated: function(index) {
                                if (index >= 0 && index < model.length)
                                    TexturePaintController.activeRampName = model[index]
                            }
                        }
                        Rectangle {
                            width: 48; height: 22; radius: 3
                            color: editRampMa.containsMouse
                                ? Qt.lighter(PropertiesPanelController.panelColor, 1.5)
                                : PropertiesPanelController.headerColor
                            border.color: PropertiesPanelController.borderColor; border.width: 1
                            anchors.verticalCenter: parent.verticalCenter
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: TexturePaintController.openRampEditor()
                            }
                        }
                    }
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Text {
                                anchors.centerIn: parent
                                text: texPaintCol.useFgBgRamp ? "✓" : ""
                                color: "white"; font.pixelSize: 9
                            }
                            MouseArea {
                                anchors.fill: parent
                                cursorShape: Qt.PointingHandCursor
                                onClicked: TexturePaintController.useFgBgRamp = !texPaintCol.useFgBgRamp
                            }
                        }
                        Text {
                            text: "Use FG/BG colours"
                            color: PropertiesPanelController.textColor
                            font.pixelSize: 10
                            anchors.verticalCenter: parent.verticalCenter
                        }
                        Rectangle {
                            width: 14; height: 14; radius: 3
                            color: texPaintCol.gradientStepped
                                ? PropertiesPanelController.highlightColor
                                : PropertiesPanelController.controlBgColor
                            border.color: PropertiesPanelController.borderColor; border.width: 1
                            anchors.verticalCenter: parent.verticalCenter
                            Text {
                                anchors.centerIn: parent
                                text: texPaintCol.gradientStepped ? "✓" : ""
                                color: "white"; font.pixelSize: 9
                            }
                            MouseArea {
                                anchors.fill: parent
                                cursorShape: Qt.PointingHandCursor
                                onClicked: TexturePaintController.gradientStepped = !texPaintCol.gradientStepped
                            }
                        }
                        Text {
                            text: "Stepped"
                    ...
                    Row {
                        ...
                        Slider {
                            id: jitterSlider
                            width: Math.min(120, parent.width - 80)
                            from: 0; to: 1; stepSize: 0.01
                            value: texPaintCol.rampJitter
                            onMoved: TexturePaintController.rampJitter = value
                        }
                        Text {
                            text: Math.round(texPaintCol.rampJitter * 100) + "%"
                            color: PropertiesPanelController.textColor
                            font.pixelSize: 10
                            opacity: 0.7
                            anchors.verticalCenter: parent.verticalCenter
