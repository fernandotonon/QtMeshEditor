...
void MainWindow::initToolBar()
{
    ...
    // ---- Paint v2 Slice H (#551): brush presets ----------------------------
    // A combo rather than a thumbnail grid: presets have no image to show (they
    // are parameter sets, not stamps), so a grid of identical tiles would carry
    // no information the name does not already give.
    {
    ...
    // ---- Paint v2 Slice H (#551): colour swatches --------------------------
    {
