...
/* Core publishes its memory map to the frontend (same ID as legacy GET_MEMORY_MAPS). */
#define RETRO_ENVIRONMENT_SET_MEMORY_MAPS (36 | RETRO_ENVIRONMENT_EXPERIMENTAL)
#define RETRO_ENVIRONMENT_GET_MEMORY_MAPS RETRO_ENVIRONMENT_SET_MEMORY_MAPS
